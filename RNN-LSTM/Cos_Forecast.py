...
seq_train = np.cos(np.linspace(start=0, stop=100, num=TRAIN_EXAMPLES, dtype=np.float32))
seq_test = np.cos(np.linspace(start=100, stop=110, num=TEST_EXAMPLES, dtype=np.float32))
