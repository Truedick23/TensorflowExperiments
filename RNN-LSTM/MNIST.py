...
#------------------------------------Generate Data-----------------------------------------------#
#generate data
train_frame = pd.read_csv("D:/PycharmProjects/RNN-LSTM/mnist_train.csv")
test_frame = pd.read_csv("D:/PycharmProjects/RNN-LSTM/mnist_test.csv")

# pop the labels and one-hot coding
train_labels_frame = train_frame.pop("object")
